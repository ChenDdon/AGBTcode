...
def add_preprocess_args(parser):
    ...
    group.add_argument("--trainoutf", metavar="FILENAME", default="train",
                       help="Output training data filename after preprocessed")
    group.add_argument("--validoutf", metavar="FILENAME", default="valid",
                       help="Output validate data filename after preprocessed")
    group.add_argument("--testoutf", metavar="FILENAME", default="test",
    ...
    parser.add_argument('--file-format', metavar='FORMAT', default=None, choices=['smiles'],
