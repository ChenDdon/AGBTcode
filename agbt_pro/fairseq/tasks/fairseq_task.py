...
class FairseqTask(object):
    ...
    @classmethod
    def build_dictionary(cls, filenames, workers=1, threshold=-1,
                         nwords=-1, padding_factor=8, fileformat=None):
        ...
        for filename in filenames:
            Dictionary.add_file_to_dictionary(filename, d, t, workers)
