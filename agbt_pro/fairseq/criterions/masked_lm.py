...
class MaskedLmLoss(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        mask_recovery = (logits.argmax(-1) == targets).int().sum().item() / sample_size
    ...
    def aggregate_logging_outputs(logging_outputs):
        ...
        agg_output = {
            ...
            'sample_size': sample_size,
            'mask_recovery': sum(log.get('mask_recovery', 0) for log in logging_outputs) / len(logging_outputs),
        }
        return agg_output
